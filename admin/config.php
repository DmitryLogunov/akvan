<?php
// HTTP
define('HTTP_SERVER', 'http://akvan.demo/admin/');
define('HTTP_CATALOG', 'http://akvan.demo/');

// HTTPS
define('HTTPS_SERVER', 'http://akvan.demo/admin/');
define('HTTPS_CATALOG', 'http://akvan.demo/');
